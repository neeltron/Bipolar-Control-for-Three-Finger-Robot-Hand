...
ENV_PY_PATH   = os.path.abspath("PPO_face_change_reward.py")  # your file with PrimitiveOnlyEnv, P, XML
MODEL_PATH    = os.path.abspath("ppo_primitives_only.zip")
VECNORM_PATH  = os.path.abspath("vecnormalize.pkl")
