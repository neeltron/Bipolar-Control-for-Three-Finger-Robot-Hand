...
ENV_PY_PATH   = os.path.abspath("orinetation_all_primitives.py")  # your file with PrimitiveOnlyEnv, P, XML
MODEL_PATH    = os.path.abspath("ppo_primitives_only_all_or.zip")
VECNORM_PATH  = os.path.abspath("vecnormalize_all_or.pkl")
