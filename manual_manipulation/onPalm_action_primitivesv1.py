...
def key_callback(keycode):
    global current_ctrl, should_update_ctrl, indexcrx, thumbcrx, p3, p4, p5, p6, p7
...
def thumb_push_to_palm():
    ...
    current_ctrl = np.array([-1.05, 2, 1.57, 0, 0, 0, 0, 0, 0, -0.698]) 
    apply_control(current_ctrl)
    step_for(100)

    current_ctrl = np.array([0.45, 0.94, 1.57, 0, 0, 0, 0, 0, 0, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)

    current_ctrl = np.array([0.45, 0.94, 1.57, -0.349, 0, 0, 0, 0, 0, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)

    current_ctrl = np.array([0.45, 0.94, 1.57, -0.349, 0, 2.5, 0, 0, 0, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)

    current_ctrl = np.array([0, 0, 1.57, 0.349, 0, 2.5, 0, 0, 0, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)


    current_ctrl = np.array([0, 0, 1.57, 0.349, 0, 2.5, 0, 0, 2.5, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)
...
def thumb_p3():
    ...
    current_ctrl = np.array([-1.05, 1.16, 1.5, -0.349, 0, 1.5, 0, 0, 2.5, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)

    current_ctrl = np.array([1.05, 2, 1.5, -0.349, 0, 1.5, 0, 0, 2.5, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)

    current_ctrl = np.array([0.534, 1, 1.5, -0.349, 0.7, 2.5, 0, 0, 2.5, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)
    current_ctrl = np.array([0.534, 1, 1.5, 0.349, 0.7, 2.5, 0, 0, 2.5, 0.698]) 
    apply_control(current_ctrl)
    ...
    current_ctrl = np.array([-1.05, 1, 1.5, 0.349, 0.7, 2.5, 0, 0, 2.5, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)
...
def thumb_p4():
    ...
    current_ctrl = np.array([0.534, 1, 1.5, -0.349, 0, 2.5, 0, 0, 2.5, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)
    current_ctrl = np.array([0.534, 1, 1.5, -0.349, 0, 2.5, 0, 0, 2.5, 0.698]) 
    apply_control(current_ctrl)
    ...
    current_ctrl = np.array([-1.05, 1, 1.5, -0.349, 0, 2.5, 0, 0, 2.5, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)
...
def ring_push():
    ...
    current_ctrl = np.array([0, 0, -0.262, -0.349, 0, 2.5, -0.349, 1, 2.5, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)
...
def ring_push1():
    ...
    #current_ctrl = np.array([0.5, 0.77, -0.262, -0.349, 0, 2.5, -0.349, 1, 2.5, 0.698]) 
    current_ctrl = np.array([0, 0, -0.262, -0.349, 0, 2.5, -0.349, 1.3, 2.5, -0.698]) 
    apply_control(current_ctrl)
    step_for(100)
...
def thumb_push():
    ...
    current_ctrl = np.array([0.5, 0.77, -0.262, -0.349, 0, 2.5, -0.349, 0, 2.5, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)
...
def index_push():
    ...
    current_ctrl = np.array([0, 0, -0.262, 0.349, 0.7, 1.5, -0.349, 0.7, 1.5, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)
...
def digits_pull_to_palm():
    current_ctrl = np.array([-1.05, 2, -0.262, -0.349, 0, 1, 0, 0, 1, -0.698]) 
    apply_control(current_ctrl)
    step_for(100)
    
    current_ctrl = np.array([0, 1.42, -0.262, -0.349, 0, 1, -0.349, 0, 1, -0.698]) 
    apply_control(current_ctrl)
    step_for(100)

    current_ctrl = np.array([-0.42, 0.33, 1, 0.349, 1.5, 1, -0.349, 2, 1, 0.698]) 
    apply_control(current_ctrl)
    step_for(100)
